...
define(['./Transforms-8cafde1e', './BoxGeometry-f1aea42c', './Cartesian2-29c15ffd', './Color-d3e9c343', './CylinderGeometry-0b00ad45', './when-f31b6bd1', './EllipsoidGeometry-baf1a3ba', './IndexDatatype-15184ec8', './createTaskProcessorWorker', './Check-ed9ffed2', './Math-03750a0b', './RuntimeError-c7c236f3', './GeometryOffsetAttribute-f6456e72', './ComponentDatatype-2ec73936', './WebGLConstants-34c08bc0', './GeometryAttribute-d59971e1', './GeometryAttributes-e973821e', './VertexFormat-44d61ac9', './CylinderGeometryLibrary-a5923d2f'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
